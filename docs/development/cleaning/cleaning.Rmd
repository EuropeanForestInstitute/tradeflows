...
```{r writetodb}
# Remove missing fields as of January 2015
columnstokeep <- column_names$efi[column_names$validated_flow] 
columnstokeep <- columnstokeep[columnstokeep %in%  names(charcoal90)]
charcoal90 <- charcoal90 %>% select_(.dots = columnstokeep) %>%
    select(-flag)
writeenddata(charcoal90)
```
