...
* There are `r nrow(swd99)` flows in the  `r unique(swd99$productcode)` dataset. 
...
Calculate prices for product code `r unique(swd99$productcode)`.
...
ggplot(swd99region2, aes(x=year, y=medianprice, color=withinregion)) +
