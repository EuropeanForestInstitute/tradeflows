...
## Clean codes on the server
#### 201708
```{r eval=FALSE}
# I first had to update the package
...
createdbstructure(sqlfile = "val_comext.sql", dbname = "tradeflows")
con <- RMySQL::dbConnect(RMySQL::MySQL(), dbname = "tradeflows")
# Transfer raw codes from the files to the database
tradeharvester::transfertxtcodesfolder2db(con, rawdatacomextfolder = "/mnt/sdb/data-raw/comext/201707/text/english/")
# Clean codes
cleanallcomextcodes(con)

# Transfer monthly data again, because productcode has a INT type instead of VARCHAT(10).
library(tradeharvester)
# Transfer monthly recent
transfer7zfolder2db(con,
                    rawdatacomextfolder = "/mnt/sdb/data-raw/comext/201708/data",
...
transfer7zfolder2db(con,
                    rawdatacomextfolder = "/mnt/sdb/data-raw/comext/2016S1/data",
                    productcodestart = c(44, 94),
