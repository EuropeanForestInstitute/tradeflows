...
Calls: <Anonymous> ... withCallingHandlers -> withVisible -> eval -> eval -> loadcomtrade_bycode
In addition: Warning messages:
1: In readLines(jsonfile) :
  incomplete final line found on '/tmp/RtmpvEcVJY/file408723f36faa.json'
2: In readLines(jsonfile) :
  incomplete final line found on '/tmp/RtmpvEcVJY/file4087782fc43a.json'
3: In readLines(jsonfile) :
  incomplete final line found on '/tmp/RtmpvEcVJY/file40872cea00f9.json'
Execution halted
``` 
