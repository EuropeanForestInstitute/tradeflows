...
## Abstract
The following report is an overview of major trade flows reported for product number `r as.character(productcodeinreport)` by `r reporterinreport` and its trade partners. `r reporterinreport` reported importing from
