...
## Comparison of trade values reported by `r reporterinreport` and its main partners

```{r fig.height=17, fig.width=12, warning=FALSE, message=FALSE}
