...
R code in this document is not evaluated by default, to avoid loading data from the API on test systems and when building package Vignettes. Copy the code in an R session to evaluate it.
